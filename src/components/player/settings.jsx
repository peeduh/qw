    ...
    <div className="relative settings-popup-container">
      <DropdownMenu open={showSettingsPopup} onOpenChange={setShowSettingsPopup}>
        <DropdownMenuTrigger asChild>
          <button
            className="border-none cursor-pointer p-2 rounded-lg flex items-center justify-center transition-all duration-200 ease-in-out w-[46px] h-[46px] relative overflow-hidden bg-transparent text-white hover:bg-white/10 hover:scale-110 active:bg-white/20 active:scale-95"
          >
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className={`flex-1 py-2 px-2 rounded-lg border transition-all duration-200 ${
                    currentSpeedIndex <= 0
