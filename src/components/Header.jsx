...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Bar */}
      <div className="fixed bottom-[-1px] left-0 w-full flex justify-around items-center py-4 pb-8 z-50 md:hidden bg-[#232323ab] backdrop-blur-lg">
        ...
        {showIOSInstall && (
          <a href="/iosapp" className="text-zinc-400 hover:text-white flex flex-col items-center transition-colors">
